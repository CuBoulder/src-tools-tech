...
The prefered client for MacOS is KeePassXC.  Download and install the [MacOS client](https://keepassxc.org/).
...
To set up syncing, download and install [Google Backup and Sync](https://www.google.com/drive/download/backup-and-sync/).  Next, in a browser, right-click the vault file located in the “SRC Web - Development and Operations Team” share, and click “...”.  The file should now automatically be synced down to your computer.
